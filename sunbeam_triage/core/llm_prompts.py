...
def diagnosis_system_prompt() -> str:
    return (
        ...
        "a Juju hook failure, call resolve_juju_unit before choosing a "
        "sosreport; then inspect the returned unit log and check colocated "
        "failing units when the error involves a shared subsystem such as "
        "APT, snapd, DNS, or networking. Never guess the bootstrap host. "
        "For "
